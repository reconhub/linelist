...
The main functions of the package include:
 ...
 - `get_vars()` accesses a variable from the linelist
...
list_epivars(ll, epivars_only = TRUE) # ignore non-epivars columns
...
```{r get_stuff}
head(gender(ll))
head(get_vars(ll, "outcome")) # only "outcome"
head(get_vars(ll, 1:3)) # first 3 epivars
