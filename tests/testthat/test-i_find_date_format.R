...
test_that("test Ybd formats", {

  x <- "2001-Jan-01"
  
  expected_format <- "%Y-%b-%d"
  names(expected_format) <- "format"
  expected_string <- as.character(x)
  names(expected_string) <- "date"
  ...
  expect_equal(i_find_date_format(x),
               i_find_date_format("2001/Jan/01"))
  expect_equal(i_find_date_format(x),
               i_find_date_format("2001 Jan 01"))
  expect_equal(i_find_date_format(x),
               i_find_date_format("2001_Jan_01"))
  expect_equal(i_find_date_format(x),
               i_find_date_format("2001.Jan.01"))

  expect_equal(i_find_date_format(x),
               i_find_date_format("this is 2001/Jan/01"))
  expect_equal(i_find_date_format(x),
               i_find_date_format("2001 Jan 01 a date 02-02-02"))
  expect_equal(i_find_date_format(x),
               i_find_date_format("mixing-2001-Jan_01 separators-_"))
  expect_equal(i_find_date_format(x),
               i_find_date_format("c'est ca: 2001.Jan.01 //../."))
...
test_that("test dmY formats", {
  ...
  expect_equal(i_find_date_format(x), i_find_date_format("21/Nov/2021"))
  expect_equal(i_find_date_format(x), i_find_date_format("21 Nov 2021"))
  expect_equal(i_find_date_format(x), i_find_date_format("21_Nov_2021"))
  expect_equal(i_find_date_format(x), i_find_date_format("21.Nov.2021"))

  expect_equal(i_find_date_format(x), i_find_date_format("21/Nov/2021 /bla/bla"))
  expect_equal(i_find_date_format(x), i_find_date_format("it's 21 Nov 2021 a"))
  expect_equal(i_find_date_format(x), i_find_date_format("date 21_Nov_2021:) "))
  expect_equal(i_find_date_format(x), i_find_date_format("... here 21.Nov.2021"))
